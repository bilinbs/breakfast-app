...
<div class="container">
	<div class="row">
		<h2>Start by selecting a set breakfast.</h2>
    </div>
    <div class="row">
        <div class="form-group">
            <div class="searchable-container">
              <c:forEach items="${bfsets}" var="bfset" >
                   <div class="items col-xs-5 col-sm-5 col-md-3 col-lg-3">
                       <div class="info-block block-info clearfaix">
                           <div class="square-box pull-left">
                               <span class="glyphicon glyphicon-tags glyphicon-lg"></span>
                           </div>
                           <div data-toggle="buttons" class="btn-group bizmoduleselect" onclick="selectBfset(${bfset.id},'${bfset.name }')">
